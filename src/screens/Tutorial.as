package screens 
{
	...
	public class Tutorial extends Sprite 
	{
		...
		private function spawn():void 
		{
			...
			new Screw(this.physics, Math.ceil(Math.random() * 4), 5545),
			new Screw(this.physics, Math.ceil(Math.random() * 4), 5845),
			new Screw(this.physics, Math.ceil(Math.random() * 4), 6055),
			new Screw(this.physics, Math.ceil(Math.random() * 4), 6400),
			new Screw(this.physics, Math.ceil(Math.random() * 4), 6745),
			new Screw(this.physics, Math.ceil(Math.random() * 4), 7045),
